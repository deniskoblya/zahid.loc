jQuery(function($) {
	...
	function initialize() {
		...
		// geocoder.geocode( { 'address': 'Львів, Львівська область'}, function(results, status) {
	...
	function calculateAndDisplayRoute(directionsService, directionsDisplay, place) {
		...
		directionsService.route({
			...
			if (status === google.maps.DirectionsStatus.OK) {
				...
				ib.close();
				addMarker(place.geometry.location.lat(), place.geometry.location.lng(), 'img/marker.png', '<b>'+place.name+'</b><p><b>Расстояние: </b>  '+distance+' km</p> <p><b>Время:</b> <span></span>'+duration+'</p>', map, 'marker-destination');
