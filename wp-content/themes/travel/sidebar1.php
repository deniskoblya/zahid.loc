...
if($site_sidebar && !is_page_template('page-institution.php') && !is_home() && !is_page_template('page-main.php') && !is_page_template('page-main-ajax.php') && !(is_page() && !is_page_template() && !is_front_page()) && !is_singular('room')){ ?>
                ...
                <?php if ($item) {
                    ...
                    <div>
                        <a href="<?php echo get_category_link($item->term_id); ?>"
                           <?php if ($current_category->term_id === $item->term_id) { ?>class="h4 active"<?php } else { ?> class="h4" <?php } ?>><?php echo esc_html($item->cat_name); ?></a>
                        <?php
                        $blog_sub_args = array(
                            'hide_empty' => 1,
                            'orderby' => 'name',
