jQuery(document).ready(function() {
	...
	jQuery( '.ulb-welcome-screen-save-add-lightbox-button' ).on( 'click', function() {
		...
		var data = 'add_lightbox=' + JSON.stringify( add_lightbox ) + '&image_class_list=' + image_class_list + '&image_selector_list=' + image_selector_list + '&action=ulb_welcome_set_options';
	...
	jQuery( '.ulb-welcome-screen-save-options-button' ).on( 'click', function() {
		...
		var data = 'show_thumbnails=' + show_thumbnails + '&show_overlay_text=' + show_overlay_text + '&background_close=' + background_close + '&mobile_hide_elements=' + JSON.stringify( mobile_hide_elements ) + '&action=ulb_welcome_set_options';
		jQuery.post( ajaxurl, data, function( response ) {} );
	...
	jQuery( '.ulb-welcome-screen-save-arrows-icons-button' ).on( 'click', function() {
		...
		var data = 'arrow=' + arrow + '&icons=' + icons + '&action=ulb_welcome_set_options';
		jQuery.post( ajaxurl, data, function( response ) {} );
	});
});
