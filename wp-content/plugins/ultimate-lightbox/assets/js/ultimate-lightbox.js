...
function EWD_ULB_Add_Lightbox_HTML(lightbox) {
	...
	Slide_Area_HTML += '<div class="ewd-ulb-slide-control ewd-ulb-slide-control-previous ewd-ulb-arrow">‹</div>';
	...
	Slide_Area_HTML += '</div>';
	Slide_Area_HTML += '<div class="ewd-ulb-slide-control ewd-ulb-slide-control-next ewd-ulb-arrow">›</div>';
	Slide_Area_HTML += '</div>';
