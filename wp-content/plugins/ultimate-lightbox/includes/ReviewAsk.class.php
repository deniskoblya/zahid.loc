...
class ulbReviewAsk {
	...
	public function enqueue_review_ask_scripts() {
		wp_enqueue_style( 'ulb-review-ask-css', ULB_PLUGIN_URL . '/assets/css/dashboard-review-ask.css' );
		wp_enqueue_script( 'ulb-review-ask-js', ULB_PLUGIN_URL . '/assets/js/dashboard-review-ask.js', array( 'jquery' ), ULB_VERSION, true  );
	}
