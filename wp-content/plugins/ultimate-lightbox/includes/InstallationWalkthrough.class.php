...
class ulbInstallationWalkthrough {
	...
	public function admin_enqueue() {
		...
		wp_enqueue_style( 'ulb-admin-css', ULB_PLUGIN_URL . '/assets/css/admin.css', array(), ULB_VERSION );
		wp_enqueue_style( 'ulb-sap-admin-css', ULB_PLUGIN_URL . '/lib/simple-admin-pages/css/admin.css', array(), ULB_VERSION );
		wp_enqueue_style( 'ulb-welcome-screen', ULB_PLUGIN_URL . '/assets/css/admin-ulb-welcome-screen.css', array(), ULB_VERSION );
		wp_enqueue_style( 'ulb-admin-settings-css', ULB_PLUGIN_URL . '/lib/simple-admin-pages/css/admin-settings.css', array(), ULB_VERSION );
		
		wp_enqueue_script( 'ulb-getting-started', ULB_PLUGIN_URL . '/assets/js/admin-ulb-welcome-screen.js', array( 'jquery' ), ULB_VERSION );
		wp_enqueue_script( 'ulb-admin-settings-js	', ULB_PLUGIN_URL . '/lib/simple-admin-pages/js/admin-settings.js', array( 'jquery' ), ULB_VERSION );
	}
