...
function ulb_add_custom_styling() {
	...
	$styling = '<style>';
		...
		if ( $ulb_controller->settings->get_setting( 'styling-background-overlay-color' ) != '' ) { $styling .=  '.ulb-booking-form form button { background-color: ' . $ulb_controller->settings->get_setting('ulb-styling-request-booking-button-background-color') . ' !important; border-color: ' . $ulb_controller->settings->get_setting('ulb-styling-request-booking-button-background-color') . ' !important; padding: 13px 28px !important; }'; }
		if ( $ulb_controller->settings->get_setting( 'styling-background-overlay-opacity' ) != '' ) { $styling .=  '.ulb-booking-form form button:hover { background-color: ' . $ulb_controller->settings->get_setting('ulb-styling-request-booking-button-background-hover-color') . ' !important; border-color: ' . $ulb_controller->settings->get_setting('ulb-styling-request-booking-button-background-hover-color') . ' !important; }'; }
