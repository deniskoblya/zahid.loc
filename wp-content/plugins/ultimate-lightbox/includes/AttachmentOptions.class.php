...
class ulbAttachmentOptions {
	...
	public function add_attachment_html( $html, $id, $caption, $title, $align, $url, $size, $alt = '' ) {
	    ...
	    update_option( 'EWD_Debugging', 'Hook getting called' );
	    if ( $id == 107 ) { update_option( 'EWD_Debugging', print_r( $html, true ) ); }
