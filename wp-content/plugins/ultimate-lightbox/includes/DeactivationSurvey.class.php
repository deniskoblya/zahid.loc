...
if ( ! class_exists( 'ulbDeactivationSurvey' ) ) {
/**
 * Class to handle plugin deactivation survey
 *
 * @since 2.0.15
 */
class ulbDeactivationSurvey {
	...
	public function enqueue_deactivation_scripts() {
		wp_enqueue_style( 'ulb-deactivation-css', ULB_PLUGIN_URL . '/assets/css/plugin-deactivation.css' );
		wp_enqueue_script( 'ulb-deactivation-js', ULB_PLUGIN_URL . '/assets/js/plugin-deactivation.js', array( 'jquery' ) );
